...
def github_login(request):  # user를 github으로 보내고
    ...
    redirect_uri = "http://airbnb-clone.eba-zp26tvmm.ap-northeast-2.elasticbeanstalk.com/users/login/github/callback"
    return redirect(
...
def kakao_login(request):  # user를 github으로 보내고
    ...
    redirect_uri = "http://airbnb-clone.eba-zp26tvmm.ap-northeast-2.elasticbeanstalk.com/users/login/kakao/callback"  # 다시 되받는곳.
    return redirect(
...
def kakao_callback(request):
    try:
        ...
        redirect_uri = "http://airbnb-clone.eba-zp26tvmm.ap-northeast-2.elasticbeanstalk.com/users/login/kakao/callback"
